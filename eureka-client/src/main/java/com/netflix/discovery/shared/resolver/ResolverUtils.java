...
public final class ResolverUtils {
    ...
    public static List<DefaultEndpoint>[] splitByZone(List<DefaultEndpoint> eurekaEndpoints, String myZone) {
        ...
        List<DefaultEndpoint> myZoneList = new ArrayList<>(eurekaEndpoints.size());
        List<DefaultEndpoint> remainingZonesList = new ArrayList<>(eurekaEndpoints.size());

        for (DefaultEndpoint endpoint : eurekaEndpoints) {
