...
import static com.netflix.appinfo.PropertyBasedInstanceConfigConstants.BROADCAST_PUBLIC_IPV4_ADDR_KEY;
...
public abstract class PropertiesInstanceConfig extends AbstractInstanceConfig implements EurekaInstanceConfig {
    ...
    public PropertiesInstanceConfig(String namespace, DataCenterInfo info) {
        ...
        this.namespace = namespace.endsWith(".")
                ? namespace
                : namespace + ".";
        appGrpNameFromEnv = DynamicPropertyFactory.getInstance().getStringProperty(FALLBACK_APP_GROUP_KEY, Values.UNKNOWN_APPLICATION).get();
