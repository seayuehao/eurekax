...
public class LegacyClusterResolver implements ClusterResolver<DefaultEndpoint> {

    private static final Logger logger = LoggerFactory.getLogger(LegacyClusterResolver.class);

    private final ClusterResolver<DefaultEndpoint> delegate;
    ...
    @Override
    public List<DefaultEndpoint> getClusterEndpoints() {
        return delegate.getClusterEndpoints();
    }

    static class LegacyClusterResolverFactory implements ClusterResolverFactory<DefaultEndpoint> {
        ...
        @Override
        public ClusterResolver<DefaultEndpoint> createClusterResolver() {
            ClusterResolver<DefaultEndpoint> newResolver = null;
...
//            }
        ...
        private List<DefaultEndpoint> createEurekaEndpointsFromConfig() {
            ...
            List<DefaultEndpoint> endpoints = new ArrayList<>(serviceUrls.size());
