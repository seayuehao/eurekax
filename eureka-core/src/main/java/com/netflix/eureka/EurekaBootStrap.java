...
public class EurekaBootStrap implements ServletContextListener {
    ...
    protected void initEurekaEnvironment() throws Exception {
        ...
        String dataCenter = DynamicPropertyFactory.getInstance().getStringProperty(EUREKA_DATACENTER, DEFAULT).get();
        if (dataCenter == null) {
            dataCenter = DynamicPropertyFactory.getInstance().getStringProperty(ARCHAIUS_DEPLOYMENT_DATACENTER, DEFAULT).get();
            logger.info("Eureka data center value eureka.datacenter is not set, defaulting to default");
        }
        String environment = DynamicPropertyFactory.getInstance().getStringProperty(EUREKA_ENVIRONMENT, TEST).get();
        if (environment == null) {
